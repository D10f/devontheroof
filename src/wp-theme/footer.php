    <footer id="contact" class="section__footer">
      ...
      <ul class="section__footer-icons">
        <li class="tooltip" data-tooltip="GitHub">
          ...
          >
            <svg aria-hidden="true">
              <use
                xlink:href="<?php echo get_theme_file_uri('images/sprite.svg') . '#icon-github-light' ?>"
              ></use>
            </svg>
          </a>
        </li>
        ...
        <li class="tooltip" data-tooltip="devsojourn@pm.me">
          ...
          >
            <svg aria-hidden="true">
              <use xlink:href="<?php echo get_theme_file_uri('images/sprite.svg') . '#icon-envelope' ?>"></use>
            </svg>
          </a>
        </li>
        ...
        <li class="tooltip" data-tooltip="PGP">
          <a
            href="<?php echo get_theme_file_uri('publickey.devsojourn@pm.me.asc'); ?>"
            download
            aria-label="downloads a pgp public key file"
          >
            <svg aria-hidden="true">
              <use xlink:href="<?php echo get_theme_file_uri('images/sprite.svg') . '#icon-key1' ?>"></use>
            </svg>
          </a>
        </li>
      </ul>
