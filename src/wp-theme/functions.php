...
function load_scripts_and_styles() {
  wp_enqueue_script('scripts', get_theme_file_uri('main.b9a9e10622384e0e9d46.js'), NULL, '1.0', true);
  wp_enqueue_style('styles', get_theme_file_uri('main.55c823c1ba874b656003.css'), NULL);
}
