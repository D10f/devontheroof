...
function load_scripts_and_styles() {
  wp_enqueue_script('scripts', get_theme_file_uri('main.0b2ea53847dd0ed71627.js'), NULL, '1.0', true);
  wp_enqueue_style('styles', get_theme_file_uri('main.e690dd3dab505a94df73.css'), NULL);
}
