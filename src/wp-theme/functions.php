...
function load_scripts_and_styles() {
  wp_enqueue_script('scripts', get_theme_file_uri('main.2878d0681c1ceadd28fa.js'), NULL, '1.0', true);
  wp_enqueue_style('styles', get_theme_file_uri('main.199108cd042db9faf83d.css'), NULL);
}
