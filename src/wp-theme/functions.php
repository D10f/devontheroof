...
function load_scripts_and_styles() {
  wp_enqueue_script('scripts', get_theme_file_uri('main.ff907fb7972934e7fdcb.js'), NULL, '1.0', true);
  wp_enqueue_style('styles', get_theme_file_uri('main.4f27edac1a73128153f3.css'), NULL);
}
